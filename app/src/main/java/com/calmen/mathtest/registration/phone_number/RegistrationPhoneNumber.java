 ...
 * @emails is the list which will be returned to caller so that caller can use it to store the email(s)
 *          in DB when registration is confirmed
 */
...
public class RegistrationPhoneNumber extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // studentId will be used to create the new PhoneNumber and Email
    ...
    public void selectContact() {
        ...
        try {
            ...
            intentReturn.putExtra("emailList", emails);
